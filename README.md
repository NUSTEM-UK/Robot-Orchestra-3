...
* Python-based orchestra controller running on a Pi host, using an [Adafruit Hella UNTZtrument](https://www.adafruit.com/product/1999) button controller board as a physical sequencer. The controller script outputs beat patterns over MQTT.
